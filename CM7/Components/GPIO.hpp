...
namespace GPIO
{
	...
	namespace STUPID {
		inline void On() { HAL_GPIO_WritePin(SPI2_CS_GPIO_Port, SPI2_CS, GPIO_PIN_SET); }
		inline void Off() { HAL_GPIO_WritePin(SPI2_CS_GPIO_Port, SPI2_CS, GPIO_PIN_RESET); }

		inline bool IsOn() { return HAL_GPIO_ReadPin(SPI2_CS_GPIO_Port, SPI2_CS) == GPIO_PIN_SET; }
	}
